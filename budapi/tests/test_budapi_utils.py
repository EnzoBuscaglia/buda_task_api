...
class TestBudapiUtils(TestCase):
    ...
    def test_get_every_public_market_id(self, mock_get_every_public_market_id):
        mock_get_every_public_market_id.return_value = [
          "btc-clp", "btc-cop", "eth-clp", "eth-btc", "btc-pen", "eth-pen", "eth-cop", "bch-btc", "bch-clp", "bch-cop", "bch-pen", "btc-ars", "eth-ars", "bch-ars", "ltc-btc", "ltc-clp", "ltc-cop", "ltc-pen", "ltc-ars", "usdc-clp", "usdc-cop", "usdc-pen", "usdc-ars", "btc-usdc", "usdt-usdc"
        ]
